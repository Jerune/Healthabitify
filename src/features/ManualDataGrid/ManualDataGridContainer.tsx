...
function ManualDataGridContainer() {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-40">
            <div className="flex flex-col relative overflow-scroll h-screen max-w-screen-2xl md:h-[85%] md:w-[90%] md:top-16 md:border md:mx-auto md:shadow-lg md:rounded-md bg-white">
